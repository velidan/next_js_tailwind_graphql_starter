      ...
      <main className="overflow-hidden">
                    ...
                    <div>
                      ...
                      <div className="mt-1">
                        <input
                          ...
                          className="border-warm-gray-300 text-warm-gray-900 block w-full rounded-md py-3 px-4 shadow-sm focus:border-teal-500 focus:ring-teal-500"
                        />
                      </div>
                    </div>
                    <div>
        ...
        <section aria-labelledby="offices-heading">
          <div className="mx-auto max-w-7xl py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
            <h2
              id="offices-heading"
              className="text-warm-gray-900 text-3xl font-bold tracking-tight"
            >
              Our offices
            </h2>
          ...
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <div className="mt-12 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  <h3 className="text-warm-gray-200 text-base font-medium">
                    Solutions
                  </h3>
